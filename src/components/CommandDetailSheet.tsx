      ...
      {cmd && p && (
        <>
          ...
          <motion.div
            ...
            className="fixed inset-x-0 bottom-0 z-[70] mx-auto max-w-lg rounded-t-[28px] border-t border-vault-border bg-vault-elevated p-5 pb-6 shadow-2xl"
          >
            <div className="mx-auto mb-4 h-1.5 w-12 rounded-full bg-vault-muted/20" />
            ...
            <header className="mb-4 space-y-2">
              ...
              <h2 className="font-mono text-[20px] font-bold tracking-tight text-vault-fg">
                {cmd.name}
              </h2>
              <p className="text-[15px] leading-relaxed text-vault-muted font-light">
                {cmd.short}
              </p>
            </header>
            ...
            <div className="mb-5 space-y-4">
              <div className="rounded-2xl bg-vault-surface p-4 ring-1 ring-vault-border">
                ...
                <p className="text-[15px] leading-relaxed text-vault-fg font-light">
                  {cmd.detail}
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              <button
                ...
                className="relative flex h-11 items-center justify-center gap-2 rounded-xl bg-vault-fg text-vault-bg text-sm font-semibold transition active:scale-[0.98]"
              >
                <AnimatePresence>
                  {copied && (
                    <motion.span
