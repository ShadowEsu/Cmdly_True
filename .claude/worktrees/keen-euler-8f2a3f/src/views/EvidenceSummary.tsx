          ...
          {[
            {
              ...
              val: 'KEY FINDING',
              desc: 'The rubric criteria and how your work was graded do not fully align. This is your strongest appeal point.',
            ...
            },
            {
              ...
              val: 'REVIEWED',
              desc: 'We checked whether the grading is consistent with the stated rubric and any course policies that apply.',
            ...
            },
            {
              ...
              val: 'FLAGGED',
              desc: 'Points were deducted without a written explanation. You have the right to ask why marks were taken.',
      ...
      <div className="sticky bottom-16 left-0 right-0 z-50 flex justify-center px-4">
        ...
        >
          ...
          <div className="flex gap-6 w-full md:w-auto">
             <button className="flex-1 md:flex-none flex items-center justify-center gap-3 px-8 py-4 rounded-xl border border-white/10 hover:bg-white/5 transition-all text-[10px] font-bold uppercase tracking-[0.3em] text-white/60">
               <ICONS.Download size={20} /> Download PDF
             </button>
             <button 
               onClick={onFinalize}
               className="flex-1 md:flex-none flex items-center justify-center gap-4 px-10 py-4 rounded-xl bg-primary text-white hover:shadow-[0_0_30px_rgba(0,35,111,0.5)] transition-all text-[10px] font-bold uppercase tracking-[0.3em] shadow-xl border border-white/20 active:scale-95"
             >
               View Full Report <ICONS.ArrowRight size={20} />
             </button>
          </div>
        </motion.div>
      </div>
